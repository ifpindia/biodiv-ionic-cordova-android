        ...
        return {
            ...
            link: function (scope, element, attrs, controllers) {
                ...
                var template = [
                    ...
                    '<p ng-bind-html="viewModel.getItemValue(selectedItem, viewModel.itemViewValueKey) | htmlContent"></p>',
                    ...
                    '<ion-item collection-repeat="item in viewModel.searchItems" item-height="60px" item-width="100%" ng-click="viewModel.selectItem(item)" ng-bind-html="viewModel.getItemValue(item, viewModel.itemViewValueKey) | htmlContent">',
